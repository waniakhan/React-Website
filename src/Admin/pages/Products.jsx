...
export default function Products() {
  ...
  const fetchProducts = () => {
    axios
      .get('http://localhost:5800/api/get-all-products')
  ...
  const deleteProduct = (_id) => {
    axios
      .delete('http://localhost:5800/api/delete-product', { data: { _id } })
      .then(() => {
        fetchProducts();
  ...
  const updateProduct = (_id, newData) => {
    axios
      .put('http://localhost:5800/api/update-product', { _id, ...newData })
      .then(() => {
        fetchProducts();
